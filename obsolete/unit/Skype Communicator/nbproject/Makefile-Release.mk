...
${OBJECTDIR}/SkypeStatus.o: SkypeStatus.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SkypeStatus.o SkypeStatus.cpp

${OBJECTDIR}/SkypeUser.o: SkypeUser.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/SkypeUser.o SkypeUser.cpp

${OBJECTDIR}/Skype.o: Skype.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Skype.o Skype.cpp
